...
return [
    ...
    'password_confirmation' => "Le champ :attribute de passe est obligatoire.",
    /*
      |--------------------------------------------------------------------------
    ...
    'custom' => [
        'expiration_date' => [
            'after' => "Le champ Date d'expiration doit être une date "
    ...
    'attributes' => [
        ...
        'lastname' => 'Nom',
        'name' => 'Nom',
        'cvv_code' => 'Code de sécurité',
        'credit_card_number' => 'Numéro de carte',
        'card_owner' => 'Nom du porteur',
