...
has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <!-- Auth::user()->lastname is the default 
value of this field. If the form is not valid, the value will change
                                     to lastname when the form will display 
again-->
...
has-error' : '' }}">
                            <label class="col-md-4 control-label">Date de naissance 
